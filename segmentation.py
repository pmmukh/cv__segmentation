...
if __name__ == '__main__':
    ...
    # fgbg_hists = np.hstack((fg_cumulative_hist,bg_cumulative_hist))
    # fgbg_superpixels = np.hstack((fg_segments,bg_segments))
    ...
    diff = RMSD(segmask,master)
    print("rmsd val is "+str(diff))
    # ======================================== #
